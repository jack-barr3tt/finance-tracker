...
import { CategoryBudget, Transaction } from "../../API"
...
type CategoryBudgetActualCardProps = {
...
export default function CategoryBudgetActualCard({
  categoryBudget,
  categoryColorMap,
  planned,
  actual,
